...
The simulation model was built for studying resource management in the clouds, focusing on how service placement strategies, service auto-migrations, and server consolidations affect the overall performance of the clouds of homogeneity and hetetrogeneity, with regard to power consumption, resource utilisation, server-level agreement violation.   
